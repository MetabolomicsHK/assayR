...
The output is a table of results.  With a labelling experiment, there's also
graphical output in the form of stacked bars to summarise the information.
...
commands in R:
    ...
    install.packages(c("RColorBrewer", "reshape2", "stringr"))
    install.packages("https://gitlab.com/jimiwills/assay.R/raw/master/AssayR_0.1.0.tar.gz", repos = NULL, type = "source")
